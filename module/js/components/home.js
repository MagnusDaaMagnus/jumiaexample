            ...
            <div class="home-page-display">
                ...
                <div class="home-parent-con" >
                    ...
                    <div class="popular-section-wrap">
                        <div class="container">
                            <div class="home-popular-wrap">
                                <!-- Text -->
                                <p class="home-popular-lg-txt line-height-zero">Popular on <span class="web-name">Jumia</span> Example</p>
                                ...
                                <div class="col-12 col-md-10 col-lg-6 mx-auto p-3">
                                    <div class="category-wrap" onclick="HomeToMobile()">
                                        <div class="container">
                                            ...
                                            <p class="home-header-sm-txt">Mobiles so good, you'll want to shout it from the rooftops. With Jumia Example, you get your hands on the best Mobiles for absolutely no fee, Mobiles that are a class apart from every other mobile.</p>
                                ...
                                <div class="col-12 col-md-10 col-lg-6 mx-auto p-3">
                                    <div class="category-wrap" onclick="HomeToTablet()">
                                        <div class="container">
                                            ...
                                            <p class="home-header-sm-txt"><span class="web-name">Jumia</span> Example is filled with the most versatile tablets on the market, infact you get to experience fun, imagination and creativity with our tablets completely for free.</p>
                                            <div class="home-header-btn">View category</div>
                                        </div>
                                        <!---->
                                ...
                                <div class="col-12 col-md-10 col-lg-6 mx-auto p-3">
                                    <div class="category-wrap" onclick="HomeToTV()">
                                        <div class="container">
                                            ...
                                            <p class="home-header-lg-txt">The most versatile Tv on <span class="web-name">Jumia</span> Example.</p>
                                            <p class="home-header-sm-txt">Experience an entirely new world wihen you receive your Televisions from <span class="web-name">Jumia</span> Example. The greatest things about our displayed Tv's is that all displayed Television offer the perfect balance of functionality and fun.</p>
                                            <div class="home-header-btn">View category</div>
                                        </div>
                                        <!---->
                    ...
                    <div class="footer-wrap">
                        <div class="container" >
                            <p class="category-lg-txt line-height">Shop with confidence on the <span class="web-name">Jumia</span> Example.</p>
