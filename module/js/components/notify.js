                ...
                <div class="support-help-wrap">
                    <div class="support-help-top">
                        ...
                        <div class="support-help-img">
                            ...
                            <p class="profile-sm-txt">To get your desired item, all you have to do is sign up with <span class="web-name">Jumia</span> Example and receive your product informations sent to your email. With this service you have access to free shippng as well as selecting any product of your choice. So now all that seperates you from your selected item is having an account with <span class="web-name">Jumia</span> Example!</p>
                            <div class="profile-header-btn" onclick="HomeSign()">Sign up now!</div>
                        </div>
                    </div>
                    
                    <div class="support-help-bot">
                        <div class="support-link-btn" onclick="document.location.href=''">Go to support on Telegram</div>       
                        <!-- Footer line-->
                    </div>
                </div>
            </div>
